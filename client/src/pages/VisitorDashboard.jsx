...
const VisitorDashboard = () => {
  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center p-8 bg-card rounded-lg shadow-md border border-destructive/20">
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="p-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-foreground">Welcome back, {user?.name || 'Visitor'}!</h1>
            <p className="text-muted-foreground mt-1">Discover Ethiopia's rich heritage and cultural treasures</p>
          </div>

          {/* Educational Platform Stats */}
          {platformStats && Object.keys(platformStats).length > 0 && (
            <div className="bg-gradient-to-r from-accent/10 to-primary/10 rounded-xl shadow-sm border border-border p-6 mb-8">
              <h2 className="text-2xl font-semibold text-foreground mb-6 text-center">📚 Educational Platform Statistics</h2>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-card rounded-lg shadow-sm border border-border">
                  <div className="text-3xl font-bold text-primary">{platformStats.totalCourses || 0}</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-gradient-to-r from-blue-50/50 to-indigo-50/50 dark:from-blue-950/20 dark:to-indigo-950/20 rounded-lg shadow-sm border border-border p-6">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-foreground">Daily Learning Challenge</h3>
                    <p className="text-sm text-muted-foreground">🔥 {userStats.streakDays || 0} day streak</p>
                  </div>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-foreground/80">Complete a quiz</span>
                  <span className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full">+10 XP</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-foreground/80">Study flashcards (5 min)</span>
                  <span className="text-xs bg-yellow-100 text-yellow-800 px-2 py-1 rounded-full">+15 XP</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-foreground/80">View virtual artifact</span>
            ...
            <div className="bg-gradient-to-r from-purple-50/50 to-pink-50/50 dark:from-purple-950/20 dark:to-pink-950/20 rounded-lg shadow-sm border border-border p-6">
              <div className="flex items-center space-x-3 mb-4">
                <div className="w-12 h-12 bg-purple-100 dark:bg-purple-900/50 rounded-full flex items-center justify-center">
                  <Zap className="h-6 w-6 text-purple-600 dark:text-purple-400" />
                </div>
                <div>
                  <h3 className="text-lg font-bold text-foreground">Quick Learning</h3>
                  <p className="text-sm text-muted-foreground">Jump into interactive content</p>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <button
                  onClick={() => navigate('/education?section=quizzes')}
                  className="flex flex-col items-center p-4 bg-card rounded-lg border border-border hover:border-purple-300 hover:shadow-sm transition-all"
                >
                  <div className="w-8 h-8 bg-purple-100 rounded-full flex items-center justify-center mb-2">
                    <Trophy className="h-4 w-4 text-purple-600" />
                  </div>
                  <span className="text-sm font-medium text-foreground">Quiz Time</span>
                ...
                >
                  ...
                  <span className="text-sm font-medium text-foreground">Explore 3D</span>
                ...
                >
                  ...
                  <span className="text-sm font-medium text-foreground">Full Course</span>
            ...
            <div className="bg-card rounded-lg shadow-sm border border-border p-6 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {featuredCourses.map((course, index) => (
                  <div key={course._id || index} className="border border-border rounded-lg overflow-hidden hover:shadow-md transition-shadow cursor-pointer bg-card">
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between text-sm">
                        <div className="flex items-center space-x-1">
                          ...
                          <span className="text-foreground/80">{course.averageRating || 0}/5</span>
                        </div>
            ...
            <div className="bg-card rounded-lg shadow-sm border border-border p-6 mb-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {categories.map((category, index) => {
                  ...
                  return (
                    <div key={index} className="text-center p-4 border border-border rounded-lg hover:shadow-md transition-shadow cursor-pointer hover:border-primary">
          ...
          <div className="bg-card rounded-lg shadow-sm border border-border p-6 mb-8">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-semibold text-foreground">Featured Museums</h2>
            ...
            {featuredMuseums.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground mb-4">No featured museums available yet.</p>
          ...
          <div className="bg-card rounded-lg shadow-sm border border-border p-6 mb-8">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-semibold text-foreground">Recently Added Artifacts</h2>
              <button className="text-amber-600 hover:text-amber-700 font-medium">Browse All</button>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              {newArtifacts.map(artifact => (
                <div key={artifact.id} className="border border-border rounded-lg overflow-hidden hover:shadow-md transition-shadow cursor-pointer">
                  <img src={artifact.image} alt={artifact.name} className="w-full h-32 object-cover" />
                  <div className="p-3">
                    <h3 className="font-medium text-foreground mb-1">{artifact.name}</h3>
                    <p className="text-sm text-muted-foreground mb-1">{artifact.museum}</p>
          ...
          <div className="bg-card rounded-lg shadow-sm border border-border p-6 mb-8">
            ...
            <div className="space-y-4">
              {upcomingEvents.map(event => (
                <div key={event.id} className="flex items-center p-4 border border-border rounded-lg hover:bg-accent/50 transition-colors cursor-pointer">
          ...
          <div className="bg-card rounded-lg shadow-sm border border-border p-6 mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <button onClick={handle3DTourClick} className="flex flex-col items-center p-4 border border-border rounded-lg hover:bg-accent/50 transition-colors">
                <Play className="h-8 w-8 text-blue-600 mb-2" />
                <Play className="h-8 w-8 text-blue-600 mb-2" />
                <span className="text-sm font-medium text-muted-foreground">3D Tours</span>
              </button>
              <button onClick={handleGalleryClick} className="flex flex-col items-center p-4 border border-border rounded-lg hover:bg-accent/50 transition-colors">
                <Image className="h-8 w-8 text-green-600 mb-2" />
                <span className="text-sm font-medium text-muted-foreground">Gallery</span>
              </button>
              <button onClick={handleEventsClick} className="flex flex-col items-center p-4 border border-border rounded-lg hover:bg-accent/50 transition-colors">
                <Calendar className="h-8 w-8 text-purple-600 mb-2" />
                <span className="text-sm font-medium text-muted-foreground">Events</span>
              </button>
              <button className="flex flex-col items-center p-4 border border-border rounded-lg hover:bg-accent/50 transition-colors">
          ...
          <div className="bg-card rounded-lg shadow-sm border border-border p-6 mb-8">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-semibold text-foreground">Your Bookings</h2>
              <div className="flex items-center gap-3">
                <button
                  onClick={refreshBookingData}
                  disabled={bookingLoading}
                  className="flex items-center gap-2 px-3 py-1 text-sm border border-input rounded-md hover:bg-accent transition-colors"
                >
            ...
            {bookedTours.length === 0 ? (
              ...
              <div className="space-y-4">
                {bookedTours.map(tour => (
                  <div key={tour.id} className="flex items-center p-4 border border-border rounded-lg">
                    <div className="flex-shrink-0 w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mr-4">
                      <Calendar className="h-6 w-6 text-blue-600" />
                    </div>
                    <div className="flex-grow">
                      <h3 className="font-medium text-foreground">{tour.title}</h3>
                      <p className="text-sm text-muted-foreground">{tour.date} at {tour.time}</p>
                    </div>
                    <span className={`px-3 py-1 text-sm rounded-full ${tour.status === 'Confirmed'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            {/* User Level & Points */}
            <div className="bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/10 dark:to-blue-900/10 rounded-xl shadow-sm border border-border p-6">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-3">
            ...
            {/* Streak & Activity */}
            <div className="bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/10 dark:to-red-900/10 rounded-xl shadow-sm border border-border p-6">
              <div className="text-center mb-4">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-orange-100 rounded-full mb-3">
                  <Zap className="h-8 w-8 text-orange-600" />
                </div>
                <h3 className="text-2xl font-bold text-foreground">{userStats.streakDays}</h3>
              ...
              <div className="space-y-2 text-center">
                <div className="flex items-center justify-center space-x-2">
                  {[...Array(7)].map((_, i) => (
                    <div
                      key={i}
                      className={`w-2 h-2 rounded-full ${i < (userStats.streakDays % 7) ? 'bg-orange-500' : 'bg-gray-200'
                        }`}
                    ></div>
                  ))}
                </div>
            ...
            {badges.length === 0 ? (
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                {badges.slice(0, 6).map((badge, index) => (
                  <div key={badge.id || index} className="text-center p-3 bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-900/10 dark:to-orange-900/10 rounded-lg hover:shadow-md transition-shadow cursor-pointer">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              <div className="space-y-3 max-h-64 overflow-y-auto">
                {activityFeed.length === 0 ? (
                  ...
                  activityFeed.slice(0, 5).map((activity, index) => (
                    <div key={index} className="flex items-start space-x-3 p-2 hover:bg-accent rounded-lg">
                      <div className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></div>
                      <div className="flex-1 min-w-0">
                        <p className="text-sm text-foreground">{activity.description || activity.action}</p>
            ...
            <div className="bg-card rounded-lg shadow-sm border border-border p-6">
              ...
              {recommendations.users && recommendations.users.length > 0 && (
                <div>
                  <h4 className="text-sm font-medium text-foreground mb-3">People to Follow</h4>
                  <div className="space-y-2">
                    {recommendations.users.slice(0, 3).map((recommendedUser) => (
                      <div key={recommendedUser._id} className="flex items-center justify-between p-2 hover:bg-accent rounded-lg">
                        <div className="flex items-center space-x-3">
                          <img
            ...
            {recentViews.length === 0 ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {recentViews.map(item => (
                  <div key={item.id} className="border border-border rounded-lg overflow-hidden hover:shadow-md transition-shadow cursor-pointer">
          ...
          <div className="bg-card rounded-lg shadow-sm border border-border p-6 mb-8">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-semibold text-foreground">Ethiopian Heritage Explorer</h2>
              <button className="text-amber-600 hover:text-amber-700 font-medium">Explore More</button>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 p-4 rounded-lg cursor-pointer hover:shadow-md transition-shadow">
                <img src="https://picsum.photos/300/200?random=10" alt="Rock Churches" className="w-full h-24 object-cover rounded-md mb-3" />
                <h3 className="font-semibold text-foreground mb-1">Rock-Hewn Churches</h3>
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 p-4 rounded-lg cursor-pointer hover:shadow-md transition-shadow">
                <img src="https://picsum.photos/300/200?random=11" alt="Simien Mountains" className="w-full h-24 object-cover rounded-md mb-3" />
                <h3 className="font-semibold text-foreground mb-1">Simien Mountains</h3>
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-900/20 dark:to-yellow-800/20 p-4 rounded-lg cursor-pointer hover:shadow-md transition-shadow">
                <img src="https://picsum.photos/300/200?random=12" alt="Harar Jugol" className="w-full h-24 object-cover rounded-md mb-3" />
                <h3 className="font-semibold text-foreground mb-1">Harar Jugol</h3>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 p-4 rounded-lg cursor-pointer hover:shadow-md transition-shadow">
                <img src="https://picsum.photos/300/200?random=13" alt="Aksum Kingdom" className="w-full h-24 object-cover rounded-md mb-3" />
                <h3 className="font-semibold text-foreground mb-1">Ancient Aksum</h3>
          ...
          <div className="bg-card rounded-lg shadow-sm border border-border p-6 mb-8">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-semibold text-foreground">Heritage Map Explorer</h2>
          ...
          <div className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-950/20 dark:to-purple-950/20 rounded-lg shadow-sm border border-border p-6 mb-8">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                <div className="p-3 bg-purple-100 dark:bg-purple-900/20 rounded-lg">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-foreground">Community Hub</h2>
                  <div className="flex items-center space-x-4">
                    <span className={`flex items-center space-x-1 text-sm ${isConnected ? 'text-green-600' : 'text-red-500'
                      }`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-2 max-h-32 overflow-y-auto">
                  {(!socketNotifications || socketNotifications.length === 0) ? (
                    ...
                    socketNotifications.slice(0, 3).map((notification, index) => (
                      <div key={index} className="p-2 bg-yellow-50 dark:bg-yellow-900/10 rounded border-l-2 border-yellow-400">
              ...
              <div className="bg-card rounded-lg shadow-sm p-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-muted-foreground">Today's Posts</span>
                    <span className="text-sm font-semibold text-blue-600">12</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-muted-foreground">Study Groups</span>
            ...
            <div className="mt-6 pt-4 border-t border-border">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <button
                  ...
                  className="flex items-center space-x-2 p-2 bg-card border border-border rounded-lg hover:bg-accent transition-colors text-sm"
                >
                ...
                <button
                  onClick={() => navigate('/community')}
                  className="flex items-center space-x-2 p-2 bg-purple-100 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg hover:bg-purple-200 dark:hover:bg-purple-900/30 transition-colors text-sm"
                >
          ...
          <div className="bg-card rounded-lg shadow-sm border border-border p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              <div className="border border-border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer">
                ...
                <h3 className="font-semibold text-foreground mb-2">Ethiopian Coffee Origins</h3>
              ...
              <div className="border border-border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer">
                ...
                <h3 className="font-semibold text-foreground mb-2">Ge'ez Script Workshop</h3>
              ...
              <div className="border border-border rounded-lg p-4 hover:shadow-md transition-shadow cursor-pointer">
                ...
                <h3 className="font-semibold text-foreground mb-2">Ethiopian Traditional Music</h3>
