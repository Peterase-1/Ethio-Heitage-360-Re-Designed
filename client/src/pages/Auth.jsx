              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-3 rounded-xl border ${errors.fullName ? 'border-destructive' : 'border-border'
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 rounded-xl border ${errors.email ? 'border-destructive' : 'border-border'
                    } bg-card text-card-foreground focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors`}
                />
              </div>
              {errors.email && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-12 py-3 rounded-xl border ${errors.password ? 'border-destructive' : 'border-border'
                    } bg-card text-card-foreground focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors`}
                />
                <button
                  type="button"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-12 py-3 rounded-xl border ${errors.confirmPassword ? 'border-destructive' : 'border-border'
                      } bg-card text-card-foreground focus:ring-2 focus:ring-primary/20 focus:border-primary transition-colors`}
                  />
                  <button
                    type="button"
                ...
                <div>
                  <label className="flex items-start">
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-4 h-4 text-primary bg-card border-border rounded focus:ring-primary/20 mt-0.5 ${errors.agreeToTerms ? 'border-destructive' : ''
                        }`}
                    />
