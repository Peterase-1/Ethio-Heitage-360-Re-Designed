    ...
    <div className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        {heroImages.map((image, index) => (
          <div
            key={index}
            className={`absolute inset-0 transition-opacity duration-[2000ms] ${index === currentImageIndex ? 'opacity-100' : 'opacity-0'
              }`}
          >
            <img
              src={image}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center text-white">
        ...
        <div className="mb-8">
          <div className="inline-flex items-center gap-2 bg-primary/20 backdrop-blur-sm px-4 py-2 rounded-full border border-primary/30 mb-6">
            ...
            <span className="text-primary-foreground text-sm font-medium">Virtual Museum Experience</span>
          </div>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-12 pr-4 py-4 text-lg bg-white/10 backdrop-blur-md border-white/20 text-white placeholder:text-stone-300 focus:border-primary focus:ring-primary/30 rounded-xl"
              />
              <Button
                onClick={handleSearch}
                className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-primary hover:bg-primary/90 text-primary-foreground px-6 py-2 rounded-lg"
              >
                Explore
              </Button>
            </div>
