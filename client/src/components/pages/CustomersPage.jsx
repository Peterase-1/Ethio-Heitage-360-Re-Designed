// Mock data removed in favor of real data from DashboardContext.

import React, { useState, useEffect } from "react";
import { Search, UserPlus, Mail, Phone, MapPin, Calendar, Eye, Edit, Trash2, Filter, Download, Loader2 } from "lucide-react";
...
export function CustomersPage() {
  const { customers, loadCustomers, addActivity, isLoading } = useDashboard();
  ...
  if (isLoading && customers.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4">
        ...
        <p className="text-stone-600">Loading customer data...</p>
      </div>
    );
  }
